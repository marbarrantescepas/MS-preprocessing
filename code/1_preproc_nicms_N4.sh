...
#SBATCH --job-name=preproc       #a convenient name for your job
#SBATCH --mem=6G                     #max memory per node --> around 3 GB for this task
...
curdir=`pwd`
dir=/home/anw/snoteboom/my-scratch/appsms
